...
Two table below shows the descriptive statistics about the sample by treatments. As can be seen majority of participants are male and balanced through treatments. In Single Roll and Free Rolls (numbers) no significant difference in dishonesty is observed while in Three Rolls and Free Rolls (symbols) dishonesty is higher.
...
Since we were able to compare the real outcomes to the reported ones, we proide a measure to analyse the magnitude of the lie or **intensive margin** of the lie, which shows the difference between the reported number and the real outcome of the first die-roll. 
